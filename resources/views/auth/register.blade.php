            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="telefonnr" class="col-md-4 col-form-label text-md-right">{{ __('Telefonnummer') }}</label>

                            <div class="col-md-6">
                                <input id="telefonnr" type="text" class="form-control @error('telefonnr') is-invalid @enderror" name="telefonnr" value="{{ old('telefonnr') }}" required autocomplete="telefonnr">
                        ...
                        <div class="form-group row">
                            <label for="houseNo" class="col-md-4 col-form-label text-md-right">{{ __('Hausnummer') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="PLZ" class="col-md-4 col-form-label text-md-right">{{ __('Postleitzahl') }}</label>

                            <div class="col-md-6">
                                <input id="PLZ" type="number" class="form-control @error('PLZ') is-invalid @enderror" name="PLZ" value="{{ old('PLZ') }}" required autocomplete="PLZ">
